...
// Take 2 parameters from command line - program, name
...
async function main() {
 ...
 let tx = await program.rpc.execute({
   accounts: {
     gmAccount: gmAccount.publicKey, // Account to store name in
     user: provider.wallet.publicKey, // User to pay for fees
 ...
 console.log('Said GM ' + storedName.number + ' times')
}
